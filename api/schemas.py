...
class PlanResponse(BaseModel):
    ...
    selected_flight: Optional[Dict[str, Any]] = Field(default=None, description="Auto-selected flight based on criteria")
    selected_hotel: Optional[Dict[str, Any]] = Field(default=None, description="Auto-selected hotel based on criteria")
    selected_car: Optional[Dict[str, Any]] = Field(default=None, description="Auto-selected car based on criteria")
